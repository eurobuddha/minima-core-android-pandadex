...
<application android:label="PandaDEX Owner Receipt Audit" android:allowBackup="false" />
...
(out/'build-evidence.json').write_text(json.dumps({
    'purpose':'Real Android maker preferences and owner-receipt process-death recovery; no node or stock-device approval',
