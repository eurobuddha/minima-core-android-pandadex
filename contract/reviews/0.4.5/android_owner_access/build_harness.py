...
<application android:label="PandaDEX Owner Access Audit" android:allowBackup="false" android:theme="@android:style/Theme.Material.NoActionBar"><activity android:name="com.eurobuddha.pandadex.OwnerHistoryAuditActivity" android:exported="false" /></application>
...
(out/'build-evidence.json').write_text(json.dumps({
    'purpose':'Real Android receipt/parser integrity, key loading and upkeep after process death; no node or stock-device approval',
