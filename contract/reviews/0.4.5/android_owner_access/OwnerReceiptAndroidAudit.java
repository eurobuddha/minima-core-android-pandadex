...
public final class OwnerReceiptAndroidAudit extends Instrumentation {
    ...
    void crash()throws Exception {
        ...
        check(prefs("owner_audit_checkpoint").edit().putInt("pid",android.os.Process.myPid()).putInt("checks",checks)
                .putInt("build",22).putBoolean("ready",true).commit(),"crash checkpoint committed");
    ...
    void recover()throws Exception {
        ...
        check(checkpoint.getBoolean("ready",false)&&checkpoint.getInt("build",0)==22,"prior crash checkpoint belongs to audit22");
    ...
    void ownerAccess()throws Exception {
        ...
        try {
            ...
            mainChecked(()->activity.show("normal",Design.Mode.DAYLIGHT));screenshot(activity,"owner-history-light.png");
