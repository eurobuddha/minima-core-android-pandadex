...
shutil.copy2(here/'ExportLifecycleAudit.java',runner/'ExportLifecycleAudit.java')
shutil.copy2(here.parent/'android_export_stream/ExportAndroidAudit.java',runner/'ExportAndroidAudit.java')
...
<application android:label="PandaDEX Export Lifecycle Audit" android:allowBackup="false">
<activity android:name="com.eurobuddha.pandadex.ExportLifecycleAudit$Host" android:exported="false" />
...
<instrumentation android:name="com.eurobuddha.pandadex.ExportLifecycleAudit" android:targetPackage="com.eurobuddha.pandadex.audit" android:functionalTest="true" />
</manifest>''')
def hashes():
...
(out/'build-evidence.json').write_text(json.dumps({
    'purpose':'Isolated retained export lifecycle, journal and document tests; no node or stock-device approval',
    'application_id':'com.eurobuddha.pandadex.audit','audit_build':args.build_number,
    'apk_sha256':hashlib.sha256(apk.read_bytes()).hexdigest(),
    'runner_sha256':hashlib.sha256((runner/'ExportLifecycleAudit.java').read_bytes()).hexdigest(),
