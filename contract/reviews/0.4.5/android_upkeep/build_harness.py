...
<application android:label="PandaDEX Upkeep Audit" android:allowBackup="false" />
...
(out/'build-evidence.json').write_text(json.dumps({
    'purpose':'Real Android key loading, maker/owner receipts and automatic upkeep after process death; no node or stock-device approval',
