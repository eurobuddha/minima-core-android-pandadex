...
shutil.copy2(here/'OwnerReceiptAndroidAudit.java',runner/'OwnerReceiptAndroidAudit.java')
...
<application android:label="PandaDEX Receipt Integrity Audit" android:allowBackup="false" />
