 ...
 * chains the next one and drives one {@link DexKeepAliveService} keep-alive pass (refresh aging reserves +
    ...
    @Override public void onReceive(Context ctx, Intent intent) {
        ...
        try {
            ContextCompat.startForegroundService(ctx,
                    new Intent(ctx, DexKeepAliveService.class).setAction(DexKeepAliveService.ACTION_HEARTBEAT));
