...
public final class Design {
    ...
    private static final String PREFS = "pandadex_design";   // SEPARATE from the fund prefs ("pandadex")
    ...
    public static int dialogTheme() { return isDark() ? R.style.DexDialogDark : R.style.DexDialogLight; }
